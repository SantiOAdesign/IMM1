...
st.title("Conversión de Texto a Audio por Santiago Osorio")
image = Image.open('IAAudio.jpg')
...
st.write('¡Ay! -dijo la IA-. El mundo se hace cada día más pequeño. Al principio era tan grande que le tenía miedo. '  
